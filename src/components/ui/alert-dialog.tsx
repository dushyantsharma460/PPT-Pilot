...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        "tw:fixed tw:inset-0 tw:z-50 tw:bg-black/30 tw:duration-100 tw:supports-backdrop-filter:backdrop-blur-sm tw:data-open:animate-in tw:data-open:fade-in-0 tw:data-closed:animate-out tw:data-closed:fade-out-0",
        className
      )}
      {...props}
    />
...
function AlertDialogMedia({
  ...
  return (
    <div
      ...
      className={cn(
        "tw:mb-2 tw:inline-flex tw:size-16 tw:items-center tw:justify-center tw:rounded-full tw:bg-muted tw:sm:group-data-[size=default]/alert-dialog-content:row-span-2 tw:*:[svg:not([class*=size-])]:size-8",
        className
      )}
      {...props}
    />
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        "tw:font-heading tw:text-lg tw:font-medium tw:sm:group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2",
        className
      )}
      {...props}
    />
