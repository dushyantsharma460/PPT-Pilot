      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <Button
              variant="ghost"
              className="tw:absolute tw:top-4 tw:right-4 tw:bg-secondary"
              size="icon-sm"
            >
              <XIcon
              />
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("tw:mt-auto tw:flex tw:flex-col tw:gap-2 tw:p-6", className)}
      {...props}
    />
  )
}
